...
import styles from './contenido4.module.css'; // Importa los estilos del módulo CSS
    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        {data.map((target, index)=>(
          <TarjetTheme content={target} index={index} key={index} borrarContenido={borrarContenido} grado='contenido4' user={user} />
        ))}
  
          { user != ""?
              <AgregarCont tipContent={'contenido4'} traerContenido={traerContenido} />
              :""
          }
      </div>
      <BotonAtras/>
